...
export class LpManagerAgent {
     ...
     */
    constructUnsignedMintTx(token0, token1, fee, tickLower, tickUpper, amount0Desired, amount1Desired) {
     ...
     */
    async rebalanceBands(poolAddress, currentPrice) {
     ...
     */
    async autoCompoundFees(poolAddress) {
