...
export class LpManagerAgent {
     ...
     */
    async executeMintTx(token0, token1, fee, tickLower, tickUpper, amount0Desired, amount1Desired) {
        if (!walletClient || !account) {
     ...
     */
    calculateImpermanentLoss(initialAmount0, initialAmount1, currentAmount0, currentAmount1, currentPrice0 // Price of Token0 in terms of Token1
    ) {
     ...
     */
    async rebalanceBands(tokenId, currentTick, entryPrice, currentPrice) {
        if (!walletClient || !account)
            return;
     ...
     */
    async autoCompoundFees(tokenId) {
        if (!walletClient || !account)
            return;
