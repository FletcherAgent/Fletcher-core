            ...
            try {
                ...
                if (isSupertrendBullish || isNewAth) {
                    ...
                    for (const agent of activeAgents) {
                        ...
                        if (agentOpenCount >= 1)
                            continue;
                        await this.lpEngine.proposeOpenPosition({ token, score: 100 }, {
                    ...
                    if (globalOpenCount < globalMaxPositions) {
                        await this.lpEngine.proposeOpenPosition({ token, score: 100 }, { dayMode: false, nightMode: false, strategyMode: true, lowerPct: 0.91, upperPct: 1.05, source: 'WATCHLIST' });
                    }
                    triggered = true;
