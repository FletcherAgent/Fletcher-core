...
const SWAP_EVENT_ABI = parseAbiItem('event Swap(address indexed sender, address indexed recipient, int256 amount0, int256 amount1, uint160 sqrtPriceX96, uint128 liquidity, int24 tick)');
export async function getTrailingVolume5m(poolAddress, token0, token1, wethPrice) {
    try {
